...
//request.setCharacterEncoding("utf-8"); //post일때만 필요
...
<jsp:useBean id="board2" class="com.kosta.dto.BoardDTO" scope="session"></jsp:useBean>
...
<%--파라메터이름(input tag의 name)과 속성이름이(VO의 변수이름) 같은 경우 생략가능  --%>
